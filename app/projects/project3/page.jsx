  ...
  return (
    <div className='project_first'>
      <div className='project1'>
        <p className='project1_title'>project 3</p>
        <a className='project1_link' href="https://main--watermelon-shop.netlify.app/" target="_blank" rel="Watermelon shop">Watermelon shop</a>
      ...
      <div className='project1_img'>
        <Image src='/watermelonshop.png' alt='watermelonshop' width={500} height={300} priority />
      </div>
    </div>
  )
}
